...
function Layout(Splide2, gridOptions, Dimension2) {
  ...
  function layout() {
    forEach2((Slide) => {
      const { slide } = Slide;
      const [rows, cols] = Dimension2.get(Slide.isClone ? Slide.slideIndex : Slide.index);
...
@splidejs/splide-extension-grid/dist/js/splide-extension-grid.esm.js:
   ...
   *)
*/
//# sourceMappingURL=@splidejs_splide-extension-grid.js.map
